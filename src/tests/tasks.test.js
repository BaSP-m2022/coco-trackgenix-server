...
describe('GET /tasks', () => {
  ...
  test.skip('response should return at least one task', async () => {
    const response = await request(app).get('/tasks').send();
...
describe('GET /:id', () => {
  test.skip('should return an specific task', async () => {
...
describe('POST /', () => {
  test.skip('should create a new task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        description: 'Trying to figure test.skip out',
        workedHours: '10',
      },
    );
  ...
  test.skip('should indicate that the task already exists', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        description: 'Trying to figure test.skip out',
        workedHours: '10',
  ...
  test.skip('should indicate the task creation', async () => {
    const response = await request(app).post('/tasks/').send(
      {
  ...
  test.skip('workedHours missing, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        description: 'This is a new task',
      },
  ...
  test.skip('description missing, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        workedHours: '10',
      },
  ...
  test.skip('workedHours must be integer numbers, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
  ...
  test.skip('workedHours must be positive numbers, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        description: 'Nice to meet you',
        workedHours: '-1',
  ...
  test.skip('description must contain at least 1 character, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
        description: '',
        workedHours: '10',
  ...
  test.skip('description should not contain symbols, should not create a task', async () => {
    const response = await request(app).post('/tasks/').send(
      {
...
describe('DELETE, /:id', () => {
  ...
  test.skip('should not find the task id', async () => {
    const response = await request(app).delete(`/tasks/${fakeId}`).send();
    expect(response.status).toBe(404);
  });
  test.skip('should indicate the task was not find', async () => {
    const response = await request(app).delete(`/tasks/${fakeId}`).send();
    expect(response.body.msg).toEqual(`Code 404: Task with id ${fakeId} not found`);
  });
  test.skip('should return undefined because of 204 status', async () => {
    const response = await request(app).delete(`/tasks/${newTask}`).send();
...
describe('PUT, /:id', () => {
  test.skip('should return a 200 status', async () => {
  ...
  test.skip('should indicate that the task does not exist - because it was deleted', async () => {
