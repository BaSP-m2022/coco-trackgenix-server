...
describe('POST /employees', () => {
  test.skip('Creation of employee', async () => {
  ...
  test.skip('if status msg is equal a status 201', async () => {
    const response = await request(app).post('/employees').send({
      firstName: 'Coco',
      lastName: 'Lobos',
      phone: '2461726',
  ...
  test.skip('should not create employee', async () => {
    const response = await request(app).post('/employees').send();
    expect(response.status).toBe(400);
  });

  test.skip('name missing, should not create a employee', async () => {
    const response = await request(app).post('/employees').send({
      lastName: 'lobos',
      phone: '2461786',
  ...
  test.skip('last name missing, should not create a employee', async () => {
    const response = await request(app).post('/employees').send({
      firstName: 'Coco',
      phone: '2462726',
  ...
  test.skip('email missing, should not create a employee', async () => {
    const response = await request(app).post('/employees').send({
      firstName: 'ricardo',
      lastName: 'dosko',
      phone: '2481826',
  ...
  test.skip('if the name has less than three letters', async () => {
    const response = await request(app).post('/employees').send({
      firstName: 'ri',
      lastName: 'dosko',
      phone: '2481826',
...
describe('GETBYID /employees/:id', () => {
  ...
  test.skip('response should return a status 404 if the id does not exist', async () => {
...
describe('PUT /employees/:id', () => {
  test.skip('status 200 if the employee was modified', async () => {
...
describe('DELETE /employees/:id', () => {
  test.skip('the employee was successfully deleted', async () => {
  ...
  test.skip('status 404 if the employee does not exist', async () => {
